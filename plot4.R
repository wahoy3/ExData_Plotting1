...
plot(Global_active_power ~ datetime, data=dtPlot, type="l", xlab="",
	ylab="Global Active Power")

plot(Voltage ~ datetime, data=dtPlot, type="l")
...
legend(x="topright", legend=paste0("Sub_metering_",c(1:3)), lty=1, col=c(1,2,4), bty="n" )

plot(Global_reactive_power ~ datetime, data=dtPlot, type="l")
dev.off()
